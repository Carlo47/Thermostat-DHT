 ...
 * Thermostat.h
 * 
 * Declaration of the class Thermostat.
 * The arguments of the constructor are the generic interface of the  
 * sensor and references to the 3 callbacks onDataReady(), onLowTemp() 
 * and onHighTemp(), which must be supplied by the application  
 * program of the class.
 * 
 * The generic interface enables the use of various sensors such as BME280, 
