 ...
 * 
 * Purpose      The program shows how a DHT11/22 temperature and humidity sensor is queried and 
 *              how these measurements are used to control an output pin which switches on and
 *              off a relais or whatever you want. 
 * 
 ...
 *                                                                                            .---------.      
 *                      DHT22                                             5V(Vin of ESP32) ---|+       ~|------------- L 
 *                 .------------.                   .----------.                              |   SSR   |    .-.        ~230V 
 *                / ° ° ° ° ° ° |-- GND -->   GND --|  ESP32   |-- 2 Heartbeat           .----|-       ~|---( L )----- N
 *               |  ° ° ° ° ° ° |-- NC              |          |                         |    `---------´    `-´
 *               |  ° ° ° ° ° ° |-- DATA-->    14 --|          |                     |¦--'                  Load
 *                \ ° ° ° ° ° ° |-- Vcc -->  3.3V --|          |                     |¦<-.  2N7000   
...
DHTSensor  sensor(DHT_TYPE, PIN_ADC, sensorData); // sensor used for thermostat
